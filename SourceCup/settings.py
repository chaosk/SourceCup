"""
Django settings for SourceCup project.
...
SECRET_KEY = 'o5q&y6n&xuv$mw-qu*ls_-0276i%+69sg+-%co55ci@_!n1%e^'
...
WSGI_APPLICATION = 'SourceCup.wsgi.application'
